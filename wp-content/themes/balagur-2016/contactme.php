...
<div id="primary" class="vb-content-area">
    <main id="contactme" class="vb-site-contactme" role="main">
        <section id="title" class="vb-title">
            <div class="container">
                <h1 class="text-center">Контакты</h1>
            </div>
        </section><!-- .vb-title -->
        <hr class="vb-small-separator">
        <section id="contact-info" class="vb-contact-info">
            <div class="container">
                <div class="vb-contactme-image">
                    <img src="/wp-content/uploads/2016/12/contactme-image-e1481906835572.jpg" alt="">
                </div>
                <div class="text-center">
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
                            <p class="vb-para bottom-offset-md">Возникли вопросы или Вы просто хотите идеальный праздник?</p>
                        </div>
                    </div>
                    <h3 class="bottom-offset-xs">телефон:</h3>
                    <div class="bottom-offset-xs"><a href="tel:+380933683780">+38(093)-368-3780</a></div>
                    <h3 class="bottom-offset-xs">e-mail:</h3>
                    <div class="bottom-offset-xl"><a href="mailto:vbalagur@yandex.ru">vbalagur@yandex.ru</a></div>
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
                            <p class="vb-para bottom-offset-md">Также можете найти меня в социальных сетях:</p>
                        </div>
                    </div>
                    <div class="vb-soc-wrapper vb-soc-wrapper-color bottom-offset-xl">
                        <a rel="nofollow" target="_blank" href="https://www.facebook.com/vlad.balagur"
                           class="soc-icon soc-icon-fcb-wrapper">
                            <svg version="1.1" id="Layer_1" class="soc-icon-fcb" xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 viewBox="-49 141 512 512" style="enable-background:new -49 141 512 512;"
                                 xml:space="preserve">
                                <g>
                                    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="28.7926" y1="575.2089"
                                ...
                                <g id="facebook">
                                    <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="113.6656"
                    ...
                    <g>
                        <g>
                            <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="28.7926" y1="575.2089"
                                            x2="385.2089" y2="218.7927">
                                <stop offset="0"/>
                                <stop offset="1"/>
                            </linearGradient>
        ...
        l224,128c1.6,0.9,3.5,1.4,5.3,1.4s3.6-0.5,5.3-1.4l224-128c3.3-1.9,5.4-5.4,5.4-9.3V279.7C441.7,275.8,439.6,272.3,436.3,270.4z
         M420.3,508.1L207,630L-6.3,508.1V285.9L207,164l213.3,121.9V508.1z"/>
                                ...
                                <g>
                                    <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="134.3947" y1="474.5912"
    ...
    C362.1,478.9,361.7,481.6,361,483z"/>
                        ...
                        <a rel="nofollow" target="_blank" href="https://instagram.com/vladislav_balagur/"
                           class="soc-icon soc-icon-insta-wrapper">
                            <svg version="1.1" id="Layer_1" class="soc-icon-insta" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 viewBox="-49 141 512 512" style="enable-background:new -49 141 512 512;" xml:space="preserve">
                                <g>
                                    <g>
                                        <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="28.7926" y1="575.2089" x2="385.2089" y2="218.7927">
                                            <stop  offset="0" />
                                            <stop  offset="1" />
                                        </linearGradient>
                                        <path class="st0" d="M436.3,270.4l-224-128c-3.3-1.9-7.3-1.9-10.6,0l-224,128c-3.3,1.9-5.4,5.4-5.4,9.3v234.7c0,3.8,2,7.4,5.4,9.3
                l224,128c1.6,0.9,3.5,1.4,5.3,1.4s3.6-0.5,5.3-1.4l224-128c3.3-1.9,5.4-5.4,5.4-9.3V279.7C441.7,275.8,439.6,272.3,436.3,270.4z
                 M420.3,508.1L207,630L-6.3,508.1V285.9L207,164l213.3,121.9V508.1z"/>
                                ...
                                <g>
                                    <g id="instagram">
                                        <g>
                                            <linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="110.1029" y1="500.2505" x2="312.6039" y2="297.7496">
                                                <stop  offset="0" />
                                                <stop  offset="1" />
                                            </linearGradient>
